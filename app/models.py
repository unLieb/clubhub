...
class InventoryItem(Base):
    ...
    stock_min = Column(Float, default=0.0)             # Soll-Bestand (in Gebinden) - Zielwert, nicht die Status-Schwelle
    ...
    # ab hier oder darunter "low"/"Niedriger Bestand" (rot) - unabhängig vom
    # Soll-Bestand. Optional; ohne eigenen Wert wird die Hälfte von stock_min
    # angenommen (siehe status.inventory_critical_threshold).
